        ...
        t = {
            687: () => {
                ...
                var g = new MutationObserver(S),
                    x = !1;
                function y() {
                    g.observe(document, { subtree: !0, childList: !0, attributes: !0, attributeOldValue: !0 }), (x = !0);
                }
                function b() {
                ...
                function S(e) {
                    ...
                    for (let o = 0; o < e.length; o++)
                        if (
                            ...
                            ("childList" === e[o].type && (e[o].addedNodes.forEach((e) => 1 === e.nodeType && t.push(e)), e[o].removedNodes.forEach((e) => 1 === e.nodeType && n.push(e))), "attributes" === e[o].type)
                        ) {
                            let t = e[o].target,
                                n = e[o].attributeName,
                                a = e[o].oldValue,
                    ...
                    for (let e of n) if (!t.includes(e) && (_.forEach((t) => t(e)), e._x_cleanups)) for (; e._x_cleanups.length;) e._x_cleanups.pop()();
                    t.forEach((e) => {
                ...
                function T(e, t, n) {
                    if (("string" == typeof t && (t = t.split(".")), 1 !== t.length)) {
                        ...
                        return e[t[0]] || (e[t[0]] = {}), T(e[t[0]], t.slice(1), n);
                    }
                    e[t[0]] = n;
                }
                var R = {};
                    ...
                    return (
                        Object.entries(R).forEach(([n, r]) => {
                            Object.defineProperty(e, `$${n}`, {
                                get() {
                                    let [e, n] = re(t);
                                    return (e = { interceptor: P, ...e }), m(t, n), r(t, e);
                                },
                                enumerable: !1,
                            });
                        }),
                                ...
                                : (function (e, t, n) {
                                    ...
                                    return (i = () => { }, { scope: o = {}, params: a = [] } = {}) => {
                                        ...
                                        if ("function" == typeof r) {
                                            ...
                                            r.finished
                                                ? (H(i, r.result, s, a, n), (r.result = void 0))
                                                : e
                                                    .then((e) => {
                                                        H(i, e, s, a, n);
                                                    })
                ...
                function H(e, t, n, r, i) {
                    if (B && "function" == typeof t) {
                        let o = t.apply(n, r);
                        o instanceof Promise ? o.then((t) => H(e, t, n, r)).catch((e) => q(e, i, t)) : e(o);
                ...
                function re(e) {
                    ...
                    r.push(o);
                    return [{ Alpine: Ge, effect: i, cleanup: (e) => r.push(e), evaluateLater: F.bind(F, e), evaluate: W.bind(W, e) }, () => r.forEach((e) => e())];
                }
                var ie = (e, t) => ({ name: n, value: r }) => (n.startsWith(e) && (n = n.replace(e, t)), { name: n, value: r });
                function oe(e = () => { }) {
                    return ({ name: t, value: n }) => {
                        let { name: r, value: i } = ae.reduce((e, t) => t(e), { name: t, value: n });
                ...
                function we(e, t = !1) {
                    return Ee(e, (e) => {
                        if ((t ? xe() : ge()).some((t) => e.matches(t))) return !0;
                    });
                }
                function Ee(e, t) {
                    if (e) {
                ...
                function ke(e, t = _e, n = () => { }) {
                    !(function (e) {
                        ...
                        t(e, (e, t) => {
                            n(e, t), Oe.forEach((n) => n(e, t)), Q(e, e.attributes).forEach((e) => e()), e._x_ignore && t();
                        });
                    });
                }
                function Ae(e) {
                ...
                function Te(e, t, n = {}) {
                    e._x_transition ||
                        (e._x_transition = {
                            ...
                            in(n = () => { }, r = () => { }) {
                                Ie(e, t, { during: this.enter.during, start: this.enter.start, end: this.enter.end }, n, r);
                            },
                            out(n = () => { }, r = () => { }) {
                                Ie(e, t, { during: this.leave.during, start: this.leave.start, end: this.leave.end }, n, r);
                            },
                        });
                }
                function Re(e) {
                ...
                function Ie(e, t, { during: n, start: r, end: i } = {}, o = () => { }, a = () => { }) {
                    ...
                    !(function (e, t) {
                        let n,
                            ...
                            o = Pe(() => {
                                O(() => {
                                    (n = !0), r || t.before(), i || (t.end(), $e()), t.after(), e.isConnected && t.cleanup(), delete e._x_transitioning;
                                });
                            });
                        (e._x_transitioning = {
                            beforeCancels: [],
                    ...
                    "function" == typeof r && (r = i(r)),
                        r
                            ...
                            : (function (e, t, n) {
                                ...
                                i &&
                                    ((e._x_transition.enter.during = { transformOrigin: d, transitionDelay: f, transitionProperty: p, transitionDuration: `${_}s`, transitionTimingFunction: m }),
                                        (e._x_transition.enter.start = { opacity: c, transform: `scale(${u})` }),
                                        (e._x_transition.enter.end = { opacity: 1, transform: "scale(1)" }));
                                o &&
                                    ((e._x_transition.leave.during = { transformOrigin: d, transitionDelay: f, transitionProperty: p, transitionDuration: `${h}s`, transitionTimingFunction: m }),
                        ...
                        case "value":
                            !(function (e, t) {
                                if ("radio" === e.type) void 0 === e.attributes.value && (e.value = t), window.fromModel && (e.checked = We(e.value, t));
                                    ...
                                    Number.isInteger(t)
                                        ? (e.value = t)
                                        : Number.isInteger(t) || Array.isArray(t) || "boolean" == typeof t || [null, void 0].includes(t)
                                            ? Array.isArray(t)
                                                ? (e.checked = t.some((t) => We(t, e.value)))
                                                : (e.checked = !!t)
                                            : (e.value = String(t));
                ...
                var Ge = {
                    ...
                    magic: I,
                    store: function (t, n) {
                        if ((He || ((Ke = e(Ke)), (He = !0)), void 0 === n)) return Ke[t];
                        (Ke[t] = n), "object" == typeof n && null !== n && n.hasOwnProperty("init") && "function" == typeof n.init && Ke[t].init(), L(Ke[t]);
                    },
                    start: function () {
                        var e;
                        document.body || he("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?"),
                    ...
                    bound: function (e, t, n) {
                        ...
                        return null === r ? ("function" == typeof n ? n() : n) : "" === r || (Fe(t) ? !![t, "true"].includes(r) : r);
                    },
                    $data: C,
                    walk: _e,
                    data: function (e, t) {
                ...
                var Xe,
                    ...
                    mt = (dt((e) => (e ? `on${ht(e)}` : "")), (e, t) => e !== t && (e == e || t == t)),
                    vt = new WeakMap(),
                    gt = [],
                    xt = Symbol("iterate"),
                ...
                function At(e, t, n) {
                    ...
                    let i = r.get(n);
                    i || r.set(n, (i = new Set())), i.has(Xe) || (i.add(Xe), Xe.deps.push(i), Xe.options.onTrack && Xe.options.onTrack({ effect: Xe, target: e, type: t, key: n }));
                }
                function St(e, t, n, r, i, o) {
                    ...
                    if ("clear" === t) a.forEach(l);
                        ...
                        switch ((void 0 !== n && l(a.get(n)), t)) {
                            case "add":
                                it(e) ? ft(n) && l(a.get("length")) : (l(a.get(xt)), ot(e) && l(a.get(yt)));
                                break;
                            case "delete":
                ...
                function Rt(e = !1) {
                    return function (t, n, r, i) {
                        let o = t[n];
                        if (!e && ((r = hn(r)), (o = hn(o)), !it(t) && mn(o) && !mn(r))) return (o.value = r), !0;
                        const a = it(t) && ft(n) ? Number(n) < t.length : rt(t, n),
                            s = Reflect.set(t, n, r, i);
                        return t === hn(i) && (a ? mt(r, o) && St(t, "set", n, r, o) : St(t, "add", n, r)), s;
                    };
                }
                ...
                var It = {
                    ...
                    ownKeys: function (e) {
                        return At(e, "iterate", it(e) ? "length" : xt), Reflect.ownKeys(e);
                    },
                },
                    zt = {
                        get: Mt,
                    ...
                    Dt = (tt({}, It, { get: Nt, set: Rt(!0) }), tt({}, zt, { get: Lt }), (e) => (st(e) ? dn(e) : e)),
                    qt = (e) => (st(e) ? pn(e) : e),
                    Bt = (e) => e,
                ...
                function Vt(e, t = !1) {
                    return (e = e.__v_raw), !t && At(hn(e), "iterate", xt), Reflect.get(e, "size", e);
                }
                function Kt(e) {
                    e = hn(e);
                    const t = hn(this);
                    return Wt(t).has.call(t, e) || (t.add(e), St(t, "add", e, e)), this;
                }
                function Ht(e, t) {
                    t = hn(t);
                    const n = hn(this),
                    ...
                    const a = i.call(n, e);
                    return n.set(e, t), o ? mt(t, a) && St(n, "set", e, t, a) : St(n, "add", e, t), this;
                }
                function Jt(e) {
                    const t = hn(this),
                        { has: n, get: r } = Wt(t);
                ...
                function Yt(e, t) {
                    return function (n, r) {
                        const i = this,
                            ...
                            a = hn(o),
                            s = t ? Bt : e ? qt : Dt;
                        return !e && At(a, "iterate", xt), o.forEach((e, t) => n.call(r, s(e), s(t), i));
                    };
                }
                function Gt(e, t, n) {
                    return function (...r) {
                ...
                ["keys", "values", "entries", Symbol.iterator].forEach((e) => {
                    (Xt[e] = Gt(e, !1, !1)), (tn[e] = Gt(e, !0, !1)), (en[e] = Gt(e, !1, !0)), (nn[e] = Gt(e, !0, !0));
                });
                var on = { get: rn(!1, !1) },
                ...
                I("nextTick", () => je),
                    ...
                    I("watch", (e, { evaluateLater: t, effect: n }) => (r, i) => {
                        let o,
                            a = t(r),
                            s = !0,
                            l = n(() =>
                ...
                function xn(e, t, n) {
                    I(t, (t) => he(`You can't use [$${directiveName}] without first installing the "${e}" plugin here: https://alpinejs.dev/plugins/${n}`, t));
                }
                I("id", (e) => (t, n = null) => {
                    let r = (function (e, t) {
                        return Ee(e, (e) => {
                    ...
                    G("modelable", (e, { expression: r }, { effect: i, evaluateLater: o, cleanup: a }) => {
                        let s = o(r),
                            l = () => {
                                let e;
                                return s((t) => (e = t)), e;
                        ...
                        u(f),
                            queueMicrotask(() => {
                                ...
                                let r = e._x_model.get,
                                    i = e._x_model.set,
                                    o = (function ({ get: e, set: r }, { get: i, set: o }) {
                                        let a,
                                            s,
                                            l,
                                            c,
                                            ...
                                            f = t(() => {
                                                let t, n;
                                                u ? ((t = e()), o(t), (n = i()), (u = !1)) : ((t = e()), (n = i()), (l = JSON.stringify(t)), (c = JSON.stringify(n)), l !== a ? ((n = i()), o(t), (n = t)) : (r(n), (t = n))),
                                                    (a = JSON.stringify(t)),
                                                    (s = JSON.stringify(n));
                                            });
                                        return () => {
                            ...
                            (o = s(o, (e, r) => {
                                ((function (e) {
                                    ...
                                    (function (e, t) {
                                        ...
                                        if (1 === n.length && On(e.key).includes(n[0])) return !1;
                                        const r = ["ctrl", "shift", "alt", "meta", "cmd", "super"].filter((e) => n.includes(e));
                                        if (((n = n.filter((e) => !r.includes(e))), r.length > 0)) {
                                            if (r.filter((t) => (("cmd" !== t && "super" !== t) || (t = "meta"), e[`${t}Key`])).length === r.length && On(e.key).includes(n[0])) return !1;
                                        }
                                        return !0;
                                    })(r, n)) ||
                                    e(r);
                ...
                function Cn() { }
                function jn(e, t, n) {
                    G(t, (r) => he(`You can't use [x-${t}] without first installing the "${e}" plugin here: https://alpinejs.dev/plugins/${n}`, r));
                }
                (bn.inline = (e, { modifiers: t }, { cleanup: n }) => {
                    ...
                    G("ignore", bn),
                    G("effect", (e, { expression: t }, { effect: n }) => n(F(e, t))),
                    G("model", (e, { modifiers: t, expression: n }, { effect: r, cleanup: i }) => {
                        let o = e;
                        t.includes("parent") && (o = e.parentNode);
                        let a,
                            s = F(o, n);
                        a = "string" == typeof n ? F(o, `${n} = __placeholder`) : "function" == typeof n && "string" == typeof n() ? F(o, `${n()} = __placeholder`) : () => { };
                        let l = () => {
                            let e;
                            ...
                            c = (e) => {
                                let t;
                                s((e) => (t = e)), An(t) ? t.set(e) : a(() => { }, { scope: { __placeholder: e } });
                            };
                        t.includes("fill") && e.hasAttribute("value") && (null === l() || "" === l()) && c(e.value),
                            "string" == typeof n &&
                            "radio" === e.type &&
                            O(() => {
                                ...
                                c(
                                    (function (e, t, n, r) {
                                        return O(() => {
                                            ...
                                            if ("checkbox" === e.type) {
                                                if (Array.isArray(r)) {
                                                    let e = t.includes("number") ? kn(n.target.value) : n.target.value;
                                                    return n.target.checked ? r.concat([e]) : r.filter((t) => !(t == e));
                                                }
                                                return n.target.checked;
                                            }
                                            if ("select" === e.tagName.toLowerCase() && e.multiple)
                                                return t.includes("number") ? Array.from(n.target.selectedOptions).map((e) => kn(e.value || e.text)) : Array.from(n.target.selectedOptions).map((e) => e.value || e.text);
                                            {
                                                let e = n.target.value;
                                                return t.includes("number") ? kn(e) : t.includes("trim") ? e.trim() : e;
                                            }
                                        });
                                    })(e, t, n, l())
                                );
                        ...
                        (e._x_model = {
                            ...
                            (e._x_forceModelUpdate = (t) => {
                                void 0 === (t = void 0 === t ? l() : t) && "string" == typeof n && n.match(/\./) && (t = ""), (window.fromModel = !0), O(() => Be(e, "value", t)), delete window.fromModel;
                            }),
                            r(() => {
                                let n = l();
                    ...
                    G("cloak", (e) => queueMicrotask(() => O(() => e.removeAttribute(Z("cloak"))))),
                    be(() => `[${Z("init")}]`),
                    G(
                        "init",
                        qe((e, { expression: t }, { evaluate: n }) => ("string" == typeof t ? !!t.trim() && n(t, {}, !1) : n(t, {}, !1)))
                    ),
                    ...
                    se(ie(":", Z("bind:"))),
                    G("bind", (e, { value: t, modifiers: n, expression: r, original: i }, { effect: o }) => {
                        if (!t) {
                            let t = {};
                            return (
                                (a = t),
                                Object.entries(Je).forEach(([e, t]) => {
                                    Object.defineProperty(a, e, { get: () => (...e) => t(...e) });
                                }),
                                void F(e, r)(
                                    (t) => {
                                        Ze(e, t, i);
                        ...
                        o(() =>
                            s((i) => {
                                void 0 === i && "string" == typeof r && r.match(/\./) && (i = ""), O(() => Be(e, t, i, n));
                            })
                        );
                    }),
                    ye(() => `[${Z("data")}]`),
                    ...
                    G("for", (t, { expression: n }, { effect: r, cleanup: i }) => {
                        let o = (function (e) {
                            let t = /,([^,\}\]]*)(?:,([^,\}\]]*))?$/,
                                n = /^\s*\(|\)\s*$/g,
                                r = /([\s\S]*?)\s+(?:in|of)\s+([\s\S]*)/,
                                    ...
                                    r((r) => {
                                        ...
                                        for (let e = 0; e < d.length; e++) {
                                            ...
                                            if (-1 === n) u.splice(e, 0, t), p.push([v, e]);
                                                ...
                                                let t = u.splice(e, 1)[0],
                                                    r = u.splice(n - 1, 1)[0];
                                                u.splice(e, 0, r), u.splice(n, 0, t), _.push([t, r]);
                                            } else m.push(t);
                                            v = t;
                                        }
                                        ...
                                        for (let t = 0; t < p.length; t++) {
                                            ...
                                            j(c, e(o), a),
                                                ...
                                                "object" == typeof s && he("x-for key cannot be an object, it must be a string or an integer", a),
                                                (l[s] = c);
                                        }
                                        for (let e = 0; e < m.length; e++) $(l[m[e]], f[d.indexOf(m[e])]);
                                        a._x_prevKeys = d;
                                    });
                                })(t, o, a, s)
                            ),
                    ...
                    G(
                        "on",
                        qe((e, { value: t, modifiers: n, expression: r }, { cleanup: i }) => {
                            let o = r ? F(e, r) : () => { };
                            ...
                            const n = (function (e, t) {
                                const n = function () {
                                    ...
                                    if (!gt.includes(n)) {
                                        wt(n);
                                        try {
                                            return Ot.push(Et), (Et = !0), gt.push(n), (Xe = n), e();
                                        } finally {
                                            gt.pop(), kt(), (Xe = gt[gt.length - 1]);
                                        }
                                    }
                                };
                ...
                Nn &&
                    ...
                    void 0 === window.Alpine && ((window.Alpine = $n), $n.start());
            },
            838: () => { },
        },
        n = {};
...
console.log('notify.js está funcionando correctamente');
