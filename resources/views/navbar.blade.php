...
<aside class="bg-gray-800 text-white w-64 h-screen fixed top-0 left-0 flex flex-col z-20">
    ...
    <nav class="flex-1 p-4">
        <ul class="space-y-2">
            ...
            <li><a href="{{ route('empleados.index') }}" class="block p-2 rounded hover:bg-gray-700">👥
                    Empleados</a></li>
            ...
            <li><a href="{{ route('configuracion.index') }}" class="block p-2 rounded hover:bg-gray-700">⚙️
                    Configuración</a></li>
        </ul>
    </nav>
</aside>