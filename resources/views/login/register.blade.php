        ...
        <div class="bg-white p-8 rounded-lg shadow-lg w-96">
            ...
            <form method="POST" action="{{ route('register.submit') }}" enctype="multipart/form-data">
                ...
                <div class="mb-6 grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="fecha_ingreso" class="block text-sm font-medium text-gray-600">Fecha de Ingreso</label>
                ...
                <div class="mb-6 grid grid-cols-2 gap-4">
                    <div>
                        <label for="tipo_contrato_id" class="block text-sm font-medium text-gray-600">Tipo de Contrato</label>
                ...
                <div class="flex justify-end">
                    <button type="submit" class="bg-blue-500 text-white px-6 py-2 rounded-md">Registrar Empleado</button>
                </div>
            </form>

            <div class="mt-6 text-center">
                <a href="{{ route('login') }}" class="text-blue-500 hover:text-blue-700">¿Ya tienes cuenta? Inicia sesión</a>
            </div>
        </div>
    </div>
